...
sobj1 <- standardize(in_NYC ~  INCOME2 + RENTHOM1 + RACE + X_HISPANC + EDUCA + LABFORCE + HLTHPLN1 + X_AGEG5YR + MARST + SEXVAR, dat_train1, family = binomial, na.action = na.pass)
...
```{r}
s_dat_test2 <- predict(sobj1, newdata = BRFSS.SUBSET,type="class")
...
sobj2 <- standardize(borough ~ INCOME2 + RENTHOM1 + RACE + X_HISPANC + EDUCA + LABFORCE  + HLTHPLN1 + X_AGEG5YR + MARST, dat_train2, family = binomial)
