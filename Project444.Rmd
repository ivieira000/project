...
acs2017_ny$INCOME2 <- cut(acs2017_ny$HHINCOME,breaks=c(0, 10000, 15000, 20000,25000,35000,50000,75000, 2030000), dig.lab=10)
...
levels(acs2017_ny$EDUC) <- c("NA","Grades 1 through 8","Grades 1 through 8","Grades 9 through 11","Grades 9 through 11","Grades 9 through 11","Grade 12 or GED", "College 1 year to 3 years", "College 1 year to 3 years", "College 1 year to 3 years", "College 4 years or more", "College 4 years or more")
...
levels(BRFSS_USE$X_IMPRACE) <- c("White","Black", "Asian","American Indian/Alaskan Native", "Other","Other")
...
```{r}
predict(model_rf1, newdata = BRFSS_USE)
```
